...
Artisan::command('chat:gemini-hse-indo', function () {
    ...
    4. Susun rekomendasi yang relevan berdasarkan semua poin "opportunity_for_improvement" pada setiap potential_danger. Jika tidak ada "opportunity_for_improvement" sama sekali, berikan rekomendasi umum pencegahan dan perbaikan yang sesuai berdasarkan konteks data.
    ...
    Anda wajib memberikan respons HANYA dalam format JSON:
    {
        ...
        "scoring": 3 | 2 | 1,
        "recommendation": "Rekomendasi berdasarkan ringkasan dari seluruh opportunity_for_improvement pada potential_danger"
    }
